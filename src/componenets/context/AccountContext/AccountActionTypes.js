...
//Fetch
export const SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_STARTED = "SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_STARTED";
export const SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_SUCCESS = "SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_SUCCESS";
export const SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_FAIL = "SINGLE_ACCOUNT_ALL_TRANSACTION_FETCH_FAIL";